                        ...
                        <form method="POST" class="register-form">
                            <div class="form-row">
                                ...
                                <div class="form-group col-xl-6">
                                    ...
                                    <input id="countryInput" placeholder="" class="form-control" name="countryInput"
                                        type="text">
                                </div>
                                ...
                                <div class="form-group col-xl-6">
                                    <div>
                                        ...
                                        <input id="phoneInput" class="form-control" name="phoneInput" type="tel"
                                ...
                                <div class="form-group col-xl-6">
                                    ...
                                    <input type="text" class="form-control" name="jobInput" id="jobInput"
                                        placeholder="">
                                </div>
                                <div class="form-group col-xl-6">
                                    <label for="companyNameInput" data-i18n="Company Name (*)">Tên công ty</label>
                                    <input type="text" class="form-control" name="companyNameInput"
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <input type="number" class="form-control" name="companySizeInput"
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <input type="number" class="form-control" name="learnerNumberInput"
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <select class="form-control" id="promotion_package">
                                        <option data-i18n="Combo 6 months free testing platform"
                                            value="six_months_free_testing_platform">Combo 6 tháng tặng
                                            testing
                                            platform</option>
                                        <option data-i18n="Combo 1 year free testing platform"
                                            value="one_year_free_testing_platform">Combo 1 năm tặng testing platform
                                        </option>
                                        <option data-i18n="Combo 6 months free 3 months"
                                            value="six_months_free_three_months">Combo 6 tháng tặng 3 tháng</option>
                        ...
                        <div class="card p-3 pb-5">
                            ...
                            <div style="margin: 0 auto;">
                                <a class="btn btn-primary button-blue d-lg-block keep-param"
                                    ...
                                    data-toggle="modal" data-target="#exampleModal">Đăng
                                    ký ngay</a>
                            </div>
