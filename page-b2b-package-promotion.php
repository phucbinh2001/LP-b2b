...
<head>
    ...
    <link rel="shortcut icon" href="https://elsaspeak.com/wp-content/themes/elsatheme/sub_theme/theme_b2b/images/ico.ico/favicon-32x32.png" type="image/x-icon" />
    <link rel="icon" href="https://elsaspeak.com/wp-content/themes/elsatheme/sub_theme/theme_b2b/images/ico.ico/favicon-32x32.png" type="image/x-icon" />
    <link rel="apple-touch-icon" sizes="152x152" href="https://elsaspeak.com/wp-content/themes/elsatheme/sub_theme/theme_b2b/images/ico.ico/apple-icon-152x152.png" />
    <link rel="apple-touch-icon" sizes="120x120" href="https://elsaspeak.com/wp-content/themes/elsatheme/sub_theme/theme_b2b/images/ico.ico/apple-icon-120x120.png" />
    <link rel="apple-touch-icon" sizes="76x76" href="https://elsaspeak.com/wp-content/themes/elsatheme/sub_theme/theme_b2b/images/ico.ico/apple-icon-76x76.png" />
    <link rel="apple-touch-icon" href="https://elsaspeak.com/wp-content/themes/elsatheme/sub_theme/theme_b2b/images/ico.ico/favicon-32x32.png" />
    <script src="https://code.jquery.com/jquery-3.6.0.min.js" integrity="sha256-/xUj+3OJU5yExlq6GSYGSHk7tPXikynS7ogEvDej/m4=" crossorigin="anonymous"></script>
    <script src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/jquery.i18n/CLDRPluralRuleParser.js">
    </script>
    <script src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/jquery.i18n/jquery.i18n.js">
    </script>
    <script src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/jquery.i18n/jquery.i18n.messagestore.js">
    </script>
    <script src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/jquery.i18n/jquery.i18n.fallbacks.js">
    </script>
    <script src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/jquery.i18n/jquery.i18n.language.js">
    </script>
    <script src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/jquery.i18n/jquery.i18n.parser.js">
    </script>
    <script src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/jquery.i18n/jquery.i18n.emitter.js">
    </script>
    <script src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/jquery.i18n/jquery.i18n.emitter.bidi.js">
    </script>
    ...
    <link rel="stylesheet" href="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/css/homepage.css?ver=8.1" type="text/css" media="all">
...
<body id="locallize_i18n">
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WQNZLV3" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
    ...
    <div class="nav-top-fixed content-header shadow">
        <div class="row d-none d-lg-flex">
            <div class="col-lg-3 col-md-12 logo">
                <a class="keep-param" href="#" id="nav-home">
                    <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/head_logo.svg" alt="logo" class="black-logo">
                </a>
            </div>
            <div class="col-lg-9 col-md-12 m-auto header-menu">
                <ul class="nav menu-header" style="float: right; align-items: center;">
                    <li class="nav-item">
                        <a class="nav-link active keep-param" data-i18n="Plans" href="#goi-san-pham" id="nav-plans">Plans</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-i18n="About Business package" href="#ve-goi-doanh-nghiep" id="nav-login">About
                            Business package</a>
                    </li>
                    <!-- <li class="nav-item">
                        ...
                        <ul class="navbar-nav">
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" id="navbarLanguage" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <img class="lang-flag" src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/lang.svg" style="width: 24px;" />
                                    <span class="text-body lang-code font-weight-bold">
                                        English
                                    </span>
                                </a>
                                <div class="dropdown-menu" aria-labelledby="navbarLanguage">
                                    <a class="dropdown-item" href="javascript:;" onclick="if (!window.__cfRLUnblockHandlers) return false; changeLanguage('vi')" data-cf-modified-b2c9fa69bf21bf5a311ec2b5-="">
                                    ...
                                    <a class="dropdown-item" href="javascript:;" onclick="if (!window.__cfRLUnblockHandlers) return false; changeLanguage('en')" data-cf-modified-b2c9fa69bf21bf5a311ec2b5-="">
        ...
        <div class="row d-lg-none d-xs-inline-flex">
            ...
            <div class="col-8 text-left">
                <span>
                    <a class="keep-param" href="#" id="nav-m-home"><img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/head_logo.svg" style="margin: 24px 0; height: 35px;" alt="logo" class="black-logo"></a>
                </span>
                <!-- Collapsible content -->
                <nav class="navbar">
                    <div class="collapse" id="navbarSupportedContent1">
                        ...
                        <ul class="navbar-nav mr-auto">
                            <li class="nav-item active">
                                <a class="nav-link keep-param" data-i18n="Plans" href="#goi-san-pham" id="nav-m-plans">Plans <span class="sr-only">(current)</span></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-i18n="About Business package" href="#ve-goi-doanh-nghiep" id="nav-m-login">About Business package</a>
                            </li>
                            <!-- <li class="nav-item">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="navbarLanguage">
                                            ...
                                            <!-- <a class="dropdown-item" href="javascript:;"
                                                ...
                                                <img src="data:image/png;base64,"
                                                    title="日本語" alt="日本語" width="16" height="11"
                                            ...
                                            <a class="dropdown-item" href="javascript:;"
                                                ...
                                                <img src="data:image/png;base64,"
                                                    title="Português" alt="Português" width="16" height="11"
                                                    style="width: 16px; height: 11px;">
                                                Português
                                            </a>
                                            <a class="dropdown-item" href="javascript:;"
                                                ...
                                                <img src="data:image/png;base64,"
                                                    title="Español" alt="Español" width="16" height="11"
                                                    style="width: 16px; height: 11px;">
                                                Español
                                            </a> -->
                                        </div>
            ...
            <div class="col-4 text-right">
                <button class="navbar-toggler toggler-example" type="button" data-toggle="collapse" data-target="#navbarSupportedContent1" aria-controls="navbarSupportedContent1" aria-expanded="false" aria-label="Toggle navigation" style="background: url(https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/burger_black.svg) no-repeat; height: 24px; margin-top: 27px;">
                </button>
            </div>
        </div>
    </div>
                        ...
                        <form method="POST" class="elsa-form">
                            <div class="form-row">
                                <div class="form-group col-xl-6">
                                    <label for="firstNameInput" data-i18n="First Name (*)">Tên</label>
                                    <input type="text" class="form-control" name="firstname" id="firstNameInput" placeholder="">
                                </div>
                                <div class="form-group col-xl-6">
                                    <label for="lastNameInput" data-i18n="Last Name (*)">Họ</label>
                                    <input type="text" class="form-control" name="lastname" id="lastNameInput" placeholder="">
                                </div>
                                ...
                                <div class="form-group col-xl-6">
                                    <label for="countryInput" data-i18n="Your Country (*)">Quốc gia</label>
                                    <input id="countryInput" placeholder="" class="form-control" name="country" type="text">
                                </div>

                                <div class="form-group col-xl-6">
                                    <div>
                                        <label for="phoneInput" data-i18n="Phone Number (*)">Số điện thoại</label>
                                        <input id="phoneInput" class="form-control" name="phone" type="tel" autocomplete="off" data-intl-tel-input-id="0" placeholder="VD: 0969 888 999">
                                    </div>
                                </div>
                                <div class="form-group col-xl-6">
                                    <label for="jobInput" data-i18n="Job Title (*)">Chức danh</label>
                                    <input type="text" class="form-control" name="job_title" id="jobInput" placeholder="">
                                </div>
                                <div class="form-group col-xl-6">
                                    <label for="companyNameInput" data-i18n="Company Name (*)">Tên công ty</label>
                                    <input type="text" class="form-control" name="organization_name" id="companyNameInput" placeholder="">
                                    <div id="duplicate_company_name"></div>
                                </div>
                                <div class="form-group col-12">
                                    <label for="companySizeInput" data-i18n="Company size (*)">Quy mô công ty</label>
                                    <input type="number" class="form-control" name="organization_size" id="companySizeInput" placeholder="">
                                </div>
                                <div class="form-group col-12">
                                    <label for="learnerNumberInput" data-i18n="Expected number of learners (*)">Ước
                                        lượng số học viên</label>
                                    <input type="number" class="form-control" name="expected_number_of_learner" id="learnerNumberInput" placeholder="">
                                </div>
                                <div class="form-group col-12">
                                    <label for="goidangky" data-i18n="Package (*)">Gói đăng ký</label>
                                    <select class="form-control" id="promotion_package">
                                        <option data-i18n="Combo 6 months free testing platform" value="six_months_free_testing_platform">Combo 6 tháng tặng
                                            testing
                                            platform</option>
                                        <option data-i18n="Combo 1 year free testing platform" value="one_year_free_testing_platform">Combo 1 năm tặng testing platform
                                        </option>
                                        <option data-i18n="Combo 6 months free 3 months" value="six_months_free_three_months">Combo 6 tháng tặng 3 tháng</option>
                                        <option data-i18n="Combo 1 year free 6 months" value="one_year_free_six_months">
                                            Combo 1 năm tặng 6 tháng</option>
                                    </select>
                                    <input type="hidden" id="utm_term" name="utm_term" value="chuachongoi">
                                </div>
                                <div class="form-group col-12">
                                    <label for="inquiryInput" data-i18n="Your inquiry">Yêu cầu</label>
                                    <textarea class="form-control" id="inquiryInput" rows="3" data-i18n="[placeholder]Detail of your inquiry"></textarea>
                                </div>
                            ...
                            <button id="b2b_register" type="submit" class="btn rounded-pill" style="background:
                                                        ...
                                                        color: white;">Đăng ký Demo</button>
                        </form>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row mx-auto">
                <div class="label-header text-center text-lg-left" style="">
                    <p class="text-size-36 title-space text-size-m-24 font-weight-600 grow-business" data-i18n="Grow your business globally with effective communication">
                        Grow your business globally with effective communication
                    </p>
                    <div class="col-md-12 pl-md-1 pr-md-1 text-header pr-lg-5">
                        <p class="text-size-20 mb-sm-4 text-size-m-16 drive-business mx-auto" data-i18n="Drive business outcomes and hold a competitive edge on the market by upskiling your organization’s English proficiency">
                    ...
                    <a class="btn btn-primary button-blue ml-lg-0 m-auto keep-param" style="padding: 13px 88px;" data-toggle="modal" data-target="#exampleModal" role="button" data-i18n="Register Now">Register
                        Now</a>
                </div>
            </div>
        </div>
    ...
    <section id="body-section" class="container-fluid text-center pl-0 pr-0" style="overflow: hidden;">
        <div class="row">
            <div class="col-md-12">
                <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/yellow_bg.svg" class="d-none d-sm-block" style="width: 213px; position: absolute; right: 2px; top: -230px;" />
                ...
                <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/company_trust4.svg" class="d-none d-lg-inline" style="width: 1112px;" />
                <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/company_trust4_m.svg" class="d-lg-none" style="width: 344px;" />
                <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/blue_bg.svg" class="d-none d-sm-block" style="width: 309px; position: absolute; left: 2px; top: -35px;" />
            </div>
        </div>
        <div class="row text-left meet-elsa-sec" id="ve-goi-doanh-nghiep">
            <div class="col-lg-6 col-md-12 order-lg-first order-last">
                <div class="row margin-left mt-lg-5 pt-lg-5">
                    <p class="text-size-36 text-size-m-24 pl-1 title-space font-weight-600" style="color: #478DFF;" data-i18n="Meet ELSA">
                        Meet ELSA
                    </p>
                    <div class="col-md-12 pl-1 pr-1 pr-lg-5 description-text" style="">
                        <p class="text-size-20 text-size-m-16" style="padding-bottom: 15px;" data-i18n="ELSA (English Language Speech Assistant) is an English pronunciation app that uses artificially intelligent speech-recognition technology to teach English pronunciation skills.">
                        ...
                        <p class="text-size-20 text-size-m-16" style="padding-bottom: 15px;" data-i18n="Our award winning speech-recognition AI will be able to give you specific remediation instructions within seconds. From audio to video support showing tongue and mouth movement, you’ll sound like a native speaker with daily practice.">
                            Our award winning speech recognition AI will be able to give you specific remediation
                    ...
                    <a class="btn btn-primary button-blue d-none d-lg-block keep-param" style="padding: 13px 65px; margin-top: -4px;" href="#goi-san-pham" data-i18n="Register Now" role="button">Register Now</a>
                </div>
            </div>
            <div class="col-lg-6 col-md-12 text-md-left text-xs-center">
                <img data-src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/meet_elsa.png" class="meet-elsa-img lazy" />
            </div>
        </div>
        <div class="row text-center elsa-org-sec">
            <div class="col-md-12">
                ...
                <div class="col-md-12 pl-1 pr-1 pr-lg-5 description-text m-auto" style="max-width: 620px;">
                    <p class="text-size-20 text-size-m-16" style="padding-bottom: 15px;" data-i18n="ELSA’s world class training program is proven to improve employee English speaking proficiency and drive business outcomes.">
                        ELSA’s world class training program is proven to improve employee English speaking proficiency
                        and drive business outcomes.
                    </p>
                </div>
                <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/red_bg.svg" class="d-none d-sm-block" style="width: 371px; position: absolute; right: 2px; top: -170px;" />
            </div>
        </div>
        <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/line_m.svg" class="d-lg-none d-xs-inline-flex" />
        <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/line1.svg" class="line-1 d-none d-lg-inline-flex" />
        <div class="row text-left">
            <div class="col-lg-6 col-md-12 order-lg-first order-last text-xs-center text-right line-mar-b">
                <img data-src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/access_lesson.png" class="access_lesson_img lazy" />
            </div>
            <div class="col-lg-6 col-md-12 text-xs-center line-mar-t mt-md-access" style="max-width: 620px;">
                <p class="text-size-36 text-size-m-24 font-weight-600 title-space" data-i18n="Give your team access to over 14,000 speaking lessons">
                    Give your team access to over 14,000 speaking lessons
                </p>
                <div class="pl-0 pr-1 pr-lg-5 description-text">
                    <p class="text-size-20 text-size-m-16" style="margin-bottom: 40px;" data-i18n="We cover all of the important speaking skills such as pronunciation, word stress, intonation, and feature over 60 topics from business English to casual conversations. Our content is easily accessible from any mobile device so your team can practice with ease.">
            ...
            <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/yellow_bg_2.svg" class="d-none d-sm-block" style="width: 243px; position: absolute; left: 2px; margin-top: 200px;" />
        </div>
        <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/line_m.svg" class="d-lg-none d-xs-inline-flex" />
        <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/line2.svg" class="line-2 d-none d-lg-inline-flex" />
        <div class="row text-left line-mar-t mt-md-5">
            <div class="col-lg-6 col-md-12 text-xs-center">
                <div class="pt-md-personalize" style="max-width: 608px;">
                    <p class="text-size-36 text-size-m-24 font-weight-600 title-space" data-i18n="Create personalized learning paths for your business units">
                        Create personalized learning paths for your business units
                    </p>
                    <div class="col-md-12 pl-0 pr-1 pr-lg-5 description-text" style="">
                        <p class="text-size-20 text-size-m-16" style="margin-bottom: 30px;" data-i18n="Our world class linguists will tailor the content to your business needs to give your employees that extra advantage by learning the vocabulary and expressions that are applicable to their daily work context.">
            ...
            <div class="col-lg-6 col-md-12 text-xs-center p-0 line-mar-b mb-md-0">
                <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/personnalize_learning.png" class="personnalize_learning_img d-none d-lg-block" />
                <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/personnalize_learning_m.png" class="personnalize_learning_img d-lg-none" />
            </div>
        </div>
        <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/line_m.svg" class="d-lg-none d-xs-inline-flex" />
        <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/line3.svg" class="line-3 d-none d-lg-inline-flex" />
        <div class="row text-left">
            <div class="col-lg-6 col-md-12 order-lg-first mt-md-dashboard order-last text-xs-center text-right p-0 line-mar-b">
                <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/dash_board.png" class="dash_board d-none d-lg-block" />
                <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/dash_board_m.png?t=13" class="dash_board d-lg-none" />
            </div>
            <div class="col-lg-6 col-md-12 text-xs-center ">
                <div class="pt-md-measure line-mar-t" style="max-width: 620px;">
                    <p class="text-size-36 text-size-m-24 font-weight-600 title-space" data-i18n="Measure and assess engagement with real time analytics">
                        Measure and assess engagement with real time analytics
                    </p>
                    <div class="col-md-12 pl-1 pr-1 pr-lg-5 description-text">
                        <p class="text-size-20 text-size-m-16" style="margin-bottom: 30px;" data-i18n="Access the status of your learning programs and stay up-to-date with your team through detailed reporting. With a suite of management tools available on our platform, you’ll be able to get insights that will drive your organization towards long-term growth.">
                    ...
                    <a class="btn btn-primary button-blue d-none d-lg-block keep-param" style="padding: 13px 65px; margin-top: -4px; max-width: 378px;" href="#goi-san-pham" role="button" data-i18n="Register Now">Register Now</a>
                </div>
                <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/blue_bg_2.svg" class="d-none d-sm-block" style="width: 309px; position: absolute; right: 2px; top: -250px;" />
            </div>
        </div>
        <section class="deal pt-5 pb-5" id="goi-san-pham">
            <p class="text-size-36 text-size-m-24 font-weight-600 m-auto mb-0" data-i18n="DISCOUNT FOR THE BUSINESS PACKAGE">GIÁ GIẢM BẤT NGỜ KHI ĐĂNG KÝ GÓI
                DOANH NGHIỆP</p>
            <p class="text-size-16 mt-2 mb-4"><span data-i18n="Promotion offer is sold as package, cannot be replaced / exchanged with any other items or additional discounts.">Ưu
                    đãi được áp dụng theo gói, không thay thế hay trao đổi với bất kỳ
                    gói
                    học nào
                    khác hoặc giảm giá thêm. </span><br>
                <b data-i18n=" ">Hình thức triển khai:</b> <span data-i18n="ELSA’s account management team will activate accounts, set up the Dashboard and Testing system, no self-activation required.">ELSA
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-md-6 mb-3">
                        <div class="card p-3 pb-5">
                            <div class="card-title m-0">
                                <p class="text-left m-0 text-white font-weight-bold text-size-36 pb-2" data-i18n="COMBO 6 MONTHS">
                                    COMBO 6 THÁNG
                                </p>
                            </div>
                                ...
                                <div class="card-content-bg p-3 pb-5 text-size-18">
                                    <div class="row mb-2 pl-3 pr-3">
                                        ...
                                        <div class="card-right col-8 pl-4 pr-0 m-0 d-flex justify-content-between">
                                            ...
                                            <p class="color-blue font-weight-600">441.750 Đ/<span class="text-size-12" data-i18n="user">học viên</span></p>
                                        </div>
                                    </div>
                                    <div class="row mb-2 pl-3 pr-3">
                                        ...
                                        <div class="card-right col-7 pl-0 pr-0 m-0 d-flex justify-content-between">
                                            ...
                                            <p class="color-blue font-weight-600">69.900 Đ/<span class="text-size-12" data-i18n="user">học viên</span></p>
                                        </div>
                                    </div>
                                    <div class="row mb-2 pl-3 pr-3">
                                        <div class="p-0 col-5 d-flex align-items-center text-left font-weight-600">
                                        ...
                                        <div class="card-right col-7 pl-0 pr-0 m-0 d-flex justify-content-between">
                                            <p class="text-size-18 m-0"><del>80.000 Đ/</del><span class="text-size-12" data-i18n="test">bài
                                                    test</span></p>
                            ...
                            <div style="margin: 0 auto;">
                                <a class="btn btn-primary button-blue d-lg-block keep-param" style="width: 378px; padding: 13px 65px; margin-top: -4px; max-width: 378px;" data-i18n="Register Now" onclick="selectPackage('six_months_free_testing_platform')" data-toggle="modal" data-target="#exampleModal">Đăng
                                    ký ngay</a>
                            </div>
                    ...
                    <div class="col-12 col-md-6 mb-3">
                        <div class="card p-3 pb-5">
                            <div class="card-title m-0">
                                <p class="text-left m-0 text-white font-weight-bold text-size-36 pb-2" data-i18n="COMBO 1 YEAR">
                                    COMBO 1 NĂM
                                </p>
                            </div>
                            <div class="card-content p-4">
                                <div class="card-content-bg p-3 pb-5 text-size-18">
                                    <div class="row mb-2 pl-3 pr-3">
                                        ...
                                        <div class="card-right col-8 pl-4 pr-0 m-0 d-flex justify-content-between">
                                            ...
                                            <p class="color-blue font-weight-600">672.300 Đ/<span class="text-size-12" data-i18n="user">học viên</span></p>
                                        </div>
                                    </div>
                                    <div class="row mb-2 pl-3 pr-3">
                                        <div class="p-0 col-5 d-flex align-items-center text-left font-weight-600">
                                        ...
                                        <div class="card-right col-7 pl-0 pr-0 m-0 d-flex justify-content-between">
                                            ...
                                            <p class="color-blue font-weight-600">139.800 Đ/<span class="text-size-12" data-i18n="user">học viên</span></p>
                                        </div>
                                    </div>
                                    <div class="row mb-2 pl-3 pr-3">
                                        <div class="p-0 col-5 d-flex align-items-center text-left font-weight-600">
                            ...
                            <div style="margin: 0 auto;">
                                <a class="btn btn-primary button-blue d-lg-block keep-param" style="width: 378px; padding: 13px 65px; margin-top: -4px; max-width: 378px;" data-i18n="Register Now" onclick="selectPackage('one_year_free_testing_platform')" data-toggle="modal" data-target="#exampleModal">Đăng
                                    ký ngay</a>
                            </div>
                        ...
                        <div class="card p-3 pb-5">
                            <div class="card-title m-0">
                                ...
                                <div class="gift-info background-white">
                                    <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/gift-icon.svg">
                                    <p class="m-0 ml-1 font-weight-bold text-size-24" data-i18n="Free 3 months">Tặng
                                        ngay 3 tháng</p>
                                </div>
                            </div>
                            <div class="card-content p-4">
                                <div class="card-content-bg p-3 pb-5 text-size-18">
                                    <div class="row mb-2 pl-3 pr-3">
                                        ...
                                        <div class="card-right col-8 pl-4 pr-0 m-0 d-flex justify-content-between">
                                            ...
                                            <p class="color-blue font-weight-600">589.000 Đ/<span class="text-size-12" data-i18n="user">học viên</span></p>
                                        </div>
                                    </div>
                                    <div class="row mb-2 pl-3 pr-3">
                                        <div class="p-0 col-5 d-flex align-items-center text-left font-weight-600">
                            ...
                            <div style="margin: 0 auto;">
                                <a class="btn btn-primary button-blue d-lg-block keep-param" style="width: 378px; padding: 13px 65px; margin-top: -4px; max-width: 378px;" data-i18n="Register Now" onclick="selectPackage('six_months_free_three_months')" data-toggle="modal" data-target="#exampleModal">Đăng
                                    ký ngay</a>
                            </div>
                    ...
                    <div class="col-12 col-md-6 mb-3">
                        <div class="card p-3 pb-5">
                            <div class="card-title m-0">
                                ...
                                <div class="gift-info background-white">
                                    <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/gift-icon.svg">
                                    <p class="m-0 ml-1 font-weight-bold text-size-24" data-i18n="Free 6 months">Tặng
                                        ngay 6 tháng</p>
                                </div>
                            </div>
                            <div class="card-content p-4">
                                <div class="card-content-bg p-3 pb-5 text-size-18">
                                    <div class="row mb-2 pl-3 pr-3">
                                        ...
                                        <div class="card-right col-8 pl-4 pr-0 m-0 d-flex justify-content-between">
                                            <p class="text-size-18 m-0 translate-custom2"><del>1.978.000 Đ</del></p>
                                            <p class="color-blue font-weight-600">989.000 Đ/<span class="text-size-12" data-i18n="user">học viên</span></p>
                                        </div>
                                    </div>
                                    <div class="row mb-2 pl-3 pr-3">
                                        <div class="p-0 col-5 d-flex align-items-center text-left font-weight-600">
                                        ...
                                        <div class="card-right col-7 pl-0 pr-0 m-0 d-flex justify-content-between">
                                            ...
                                            <p class="color-blue font-weight-600">279.600 Đ/<span class="text-size-12" data-i18n="user">học viên</span></p>
                                        </div>
                                    </div>
                                    <div class="row mb-2 pl-3 pr-3">
                                        <div class="p-0 col-5 d-flex align-items-center text-left font-weight-600">
                            ...
                            <div style="margin: 0 auto;">
                                <a class="btn btn-primary button-blue d-lg-block keep-param" style="width: 378px; padding: 13px 65px; margin-top: -4px; max-width: 378px;" data-i18n="Register Now" onclick="selectPackage('one_year_free_six_months')" data-toggle="modal" data-target="#exampleModal">Đăng
                                    ký ngay</a>
                            </div>
        ...
        <div class="elsa-by-number">
            <div class="row text-center elsa-with-number">
                <div class="col-12">
                    ...
                    <div class="col-md-12 mx-auto" style="max-width: 478px;">
                        <p class="text-size-20 font-weight-400 text-size-m-16 mb-2 mb-md-3" style="opacity: 0.8; mix-blend-mode: normal;" data-i18n="Learners that use ELSA regularly reported significant improvement in their communication and productivity.*">
            ...
            <div class="row text-center text-white group-image-num container">
                <div class="col-lg-4 col-md-12 mt-auto ">
                    <div class="number-box">
                        <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/spaceship.png" class="icon" />
                        <p class="font-weight-600 mb-2 mt-3 percentage" style="color: #0099FF;">
                            90%
                        </p>
                        <p class="text-size-20 text-size-m-16 mb-1 mb-lg-3" data-i18n="Saw an improvement in pronunciation">
                ...
                <div class="col-lg-4 col-md-12 mt-auto ">
                    <div class="number-box">
                        <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/smile.png" class="icon" />
                ...
                <div class="col-lg-4 col-md-12 mt-auto ">
                    <div class="number-box">
                        <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/trend-up.png" class="icon" />
                        <p class="font-weight-600 mb-2 mt-3 percentage" style="color: #FF9518;">
                            95%
                        </p>
                        <p class="text-size-20 text-size-m-16 mb-1 mb-lg-3" data-i18n="Expressed higher confidence in speaking english">
                            Expressed higher confidence in speaking english
                        </p>
                    </div>
                </div>
            </div>
            <p class="text-size-14 text-white font-weight-400 pt-4 text-center text-size-m-12 d-none d-lg-block" style="opacity: 0.7; mix-blend-mode: normal;" data-i18n="(*Based on learners who use ELSA for 10 minutes a day for three months.)">
            ...
            <div class="row text-center text-white elsa_number_text">
                <div class="col-lg-3 col-md-12 mt-auto">
                    <p class="text-size-22 text-size-m-16 mb-1 mb-lg-3" style="opacity: 0.8;" data-i18n="Proudly serves">
                        Proudly serves
                    </p>
                    <p class="text-size-24 text-size-m-20 font-weight-600 font-weight-m-500 mb-1 mb-lg-3" data-i18n="13 million users">
                        13 million users
                    </p>
                </div>
                ...
                <div class="col-lg-4 col-md-12 mt-auto">
                    <p class="text-size-24 text-size-m-20 font-weight-600 font-weight-m-500 mb-1 mb-lg-3" data-i18n="#1 recommended">
                        #1 recommended
                    </p>
                    <p class="text-size-22 text-size-m-16 mb-1 mb-lg-3" style="opacity: 0.8;" data-i18n="by ESL teachers world wide">
                ...
                <hr class="d-lg-none" style="background: #C4C4C4; opacity: 0.2; height: 1px; width: 60px;" />
                <div class="col-lg-3 col-md-12 mt-auto ">
                    <p class="text-size-24 text-size-m-20 font-weight-600 font-weight-m-500 mb-1 mb-lg-3" data-i18n="300M exercises">
                        300M exercises
                    </p>
        ...
        <div class="row text-center improve-communica">
            <div class="col-md-12">
                <p class="text-size-36 text-size-m-24 font-weight-600 title-space m-auto" data-i18n="How ELSA helps improve communication effectiveness and business results">
                ...
                <div class="col-md-12 pl-1 pr-1 pr-lg-5 description-text m-auto">
                    <p class="text-size-20 text-size-m-16" style="padding-bottom: 15px; opacity: 0.8;" data-i18n="ELSA offers a diverse and updated content and resources to improve people's English pronunciation in a short period of time">
        ...
        <div class="row text-left bulllet-slice-sec desktop">
            <div class="col-lg-6 col-md-12">
                <div class="row margin-left-30">
                    <div class="row pt-4 pb-4 item-slide-width ml-0 mr-0 item-0 back-ground-active" data-target="#slider" data-slide-to="0">
                        <div class="icon col-md-2 text-xs-left text-md-center mb-3 mt-md-3">
                            <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/instant_icon.svg" class="icon-inactive" style="width: 34px; display: none;" />
                            <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/instant_icon_active.svg" class="icon-active" style="width: 34px;" />
                        </div>
                        <div class="col-md-10 pl-md-0">
                            <p class="text-size-20 text-size-m-18 font-weight-600 mb-2 title-item title-active" data-i18n="Instant and precise pronunciation feedback">
                                Instant and precise pronunciation feedback
                            </p>
                            <p class="text-size-20 text-size-m-16 mb-0" style="opacity: 0.8;" data-i18n="ELSA's proprietary voice recognition technology, ranked among the top 5 artificial intelligence apps, pinpoint exactly what learners need to improve from individual sounds to intonation and fluency.">
                    ...
                    <div class="row pt-4 pb-4 item-slide-width ml-0 mr-0 item-1" data-target="#slider" data-slide-to="1">
                        <div class="icon col-md-2 text-xs-left text-md-center mb-3 mt-md-3">
                            <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/rec_icon.svg" class="icon-inactive" style="width: 34px;" />
                            <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/rec_icon_active.svg" class="icon-active" style="width: 34px; display: none;" />
                        </div>
                        <div class="col-md-10 pl-md-0">
                            <p class="text-size-20 text-size-m-18 font-weight-600 mb-2 title-item" data-i18n="Recommended lessons and features">
                                Recommended lessons and features
                            </p>
                            <p class="text-size-20 text-size-m-16 mb-0" style="opacity: 0.8;" data-i18n="Relevant, updated content and features can help you find interesting lessons and improve quickly">
                                Relevant, updated content and features can help you find interesting lessons and improve
                                quickly
                            </p>
                        </div>
                    </div>
                    <div class="row pt-4 pb-4 item-slide-width item-2 ml-0 mr-0" data-target="#slider" data-slide-to="2">
                        <div class="icon col-md-2 text-xs-left text-md-center mb-3 mt-md-3">
                            <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/explore_icon.svg" class="icon-inactive" style="width: 34px;" />
                            <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/explore_icon_active.svg" class="icon-active" style="width: 34px; display: none;" />
                        </div>
                        <div class="col-md-10 pl-md-0">
                            <p class="text-size-20 text-size-m-18 font-weight-600 mb-2 title-item" data-i18n="Explore more than 60 topics">
                                Explore more than 60 topics
                            </p>
                            <p class="text-size-20 text-size-m-16 mb-0" style="opacity: 0.8;" data-i18n="Variety of topics ranging from Daily Conversation to Work and Career have help millions of users improve daily life and industry vocabulary">
                    ...
                    <div class="row pt-4 pb-4 item-slide-width item-3 ml-0 mr-0" data-target="#slider" data-slide-to="3">
                        <div class="icon col-md-2 text-xs-left text-md-center mb-3 mt-md-3">
                            <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/pronu_icon.svg" class="icon-inactive" style="width: 34px;" />
                            <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/pronu_icon_active.svg" class="icon-active" style="width: 34px; display: none;" />
                        </div>
                        <div class="col-md-10 pl-md-0">
                            <p class="text-size-20 text-size-m-18 font-weight-600 mb-2 title-item" data-i18n="Different pronunciation practice types">
                                Different pronunciation practice types
                            </p>
                            <p class="text-size-20 text-size-m-16 mb-0" style="opacity: 0.8;" data-i18n="Multiple game types to help you focus on a specific skill, resulting in faster improvement">
                                Multiple game types to help you focus on a specific skill, resulting in faster
                                improvement
                            </p>
                        </div>
                    </div>
                    <div class="row pt-4 pb-4 item-slide-width item-4 ml-0 mr-0" data-target="#slider" data-slide-to="4">
                        <div class="icon col-md-2 text-xs-left text-md-center mb-3 mt-md-3">
                            <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/dic_icon.svg" class="icon-inactive" style="width: 34px;" />
                            <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/dic_icon_active.svg" class="icon-active" style="width: 34px; display: none;" />
                        </div>
                        <div class="col-md-10 pl-md-0">
                            <p class="text-size-20 text-size-m-18 font-weight-600 mb-2 title-item" data-i18n="Dictionary Function">
                                Dictionary Function
                            </p>
                            <p class="text-size-20 text-size-m-16 mb-0" style="opacity: 0.8;" data-i18n="Speak any word and get instant feedback to improve your pronunciation and speaking skill">
                                Speak any word and get instant feedback to improve your pronunciation and speaking skill
                            </p>
                        </div>
                    </div>
                    <div class="row pt-4 pb-4 item-slide-width item-5 ml-0 mr-0" data-target="#slider" data-slide-to="5">
                        <div class="icon col-md-2 text-xs-left text-md-center mb-3 mt-md-3">
                            <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/daily_icon.svg" class="icon-inactive" style="width: 34px;" />
                            <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/daily_icon_active.svg" class="icon-active" style="width: 34px; display: none;" />
                        </div>
                        <div class="col-md-10 pl-md-0">
                            <p class="text-size-20 text-size-m-18 font-weight-600 mb-2 title-item" data-i18n="Daily personalized lessons with Coach">
                                Daily personalized lessons with Coach
                            </p>
                            <p class="text-size-20 text-size-m-16 mb-0" style="opacity: 0.8;" data-i18n="Recommended daily lessons based on your level of proficiency and interest to accelerate your improvement">
                ...
                <div id="slider" class="carousel slide carousel-fade" data-ride="carousel">
                    ...
                    <div class="carousel-inner m-auto">
                        <div class="carousel-item active">
                            <img class="d-block w-image lazy" data-src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/instant_slide.png?t=12">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-image lazy" data-src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/rec_slide.png">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-image lazy" data-src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/explore_slide.png">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-image lazy" data-src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/pronu_slide.png">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-image lazy" data-src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/dic_slide.png">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-image lazy" data-src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/daily_slide.png">
                        </div>
                    </div>
                </div>
                <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/blue_bg_2.svg" class="d-none d-sm-block" style="width: 309px; position: absolute; right: 2px; top: 350px;" />
            </div>
        </div>
        <div id="carouselBulletImage" class="carousel slide text-center m-auto mobile carousel-fade" data-ride="carousel">
            <ol class="carousel-indicators">
                ...
                <div class="carousel-item active">
                    <div class="row pt-4 pb-4 item-slide-width ml-0 mr-0 item-0">
                        <div class="icon col-md-2 text-center mb-3 mt-md-3 mx-auto">
                            <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/instant_icon.svg" class="icon-inactive" style="width: 34px;" />
                        </div>
                        <div class="col-md-10 pl-md-0 mb-4">
                            <p class="text-size-20 text-size-m-18 font-weight-600 mb-2 title-item" data-i18n="Instant and precise pronunciation feedback">
                                Instant and precise pronunciation feedback
                            </p>
                            <p class="text-size-20 text-size-m-16 mb-0" style="opacity: 0.8;" data-i18n="ELSA's proprietary voice recognition technology, ranked among the top 5 artificial intelligence apps, pinpoint exactly what learners need to improve from individual sounds to intonation and fluency.">
                                ELSA's proprietary voice recognition technology, ranked among the top 5 artificial
        ...
        <div class="row see-plan-sec">
            <div class="col-md-12 pl-0 pr-0">
                <div class="see-plan">
                    ...
                    <a class="btn btn-primary button-white keep-param" href="#goi-san-pham" role="button" data-i18n="See Plans">See Plans</a>
                </div>
            </div>
        </div>
        <p class="text-size-36 text-size-m-24 font-weight-600 m-auto title-partner" style="padding-top: 40px;" data-i18n="What our partners say">
        ...
        <div id="carouselPartner" class="carousel slide m-auto" data-ride="carousel">
            ...
            <div class="carousel-inner m-auto text-left">
                <div class="carousel-item active">
                    ...
                    <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/fpt.png" alt="" style="max-width: 185px; max-height: 50px;" />
                </div>
                <div class="carousel-item">
                    <p class="text-size-20 text-size-m-18 line-height-partner text-justify" data-i18n="LINKBYNET Testimonial">
                    ...
                    <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/LinkbyNet.png" class="" style="max-width: 185px; max-height: 50px;" />
                </div>
                <div class="carousel-item">
                    <p class="text-size-20 text-size-m-18 line-height-partner text-justify" data-i18n="RICE Testimonial">
                    ...
                    <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/rice_university.png" alt="" style="max-width: 185px; max-height: 50px;" />
                </div>
                <div class="carousel-item">
                    <p class="text-size-20 text-size-m-18 line-height-partner text-justify" data-i18n="CHABOT Testimonial">
                    ...
                    <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/Chabot.png" alt="" style="max-width: 185px; max-height: 50px;" />
                </div>
                <div class="carousel-item">
                    <p class="text-size-20 text-size-m-18 line-height-partner text-justify" data-i18n="[html]YOLA Testimonial">
                    ...
                    <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/YOLA.png" alt="" style="max-width: 185px; max-height: 50px;" />
                </div>
                <div class="carousel-item">
                    <p class="text-size-20 text-size-m-18 line-height-partner text-justify" data-i18n="IMAP Testimonial">
                    ...
                    <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/logo_IMAP.jpg" alt="" style="max-width: 185px; max-height: 50px;" />
                </div>
            </div>
            <a class="carousel-control-prev desktop" href="#carouselPartner" role="button" data-slide="prev">
                <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/prev.svg" style="width: 90px;" />
            </a>
            <a class="carousel-control-next desktop" href="#carouselPartner" role="button" data-slide="next">
                <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/next.svg" style="width: 90px;" />
            </a>
        </div>
    </section>
    <style>
            ...
            <div class="row menu-header">
                <div class="col-lg-5 col-md-12 mb-4 pb-2 mb-md-0 mt-md-2 text-left align-left">
                    <a class="keep-param" href="#" id="footer-nav-home">
                        <img src="https://vn.elsaspeak.com/wp-content/themes/theme-b2b-package-promotion/assets/img/logo_elsa_2.svg" alt="logo" />
                    </a>
                </div>
                <div class="col-lg-7 col-md-12 align-right">
                    <div class="row row d-none d-lg-flex">
                        <div class="col-4 text-left font-weight-600">
                            <a class="nav-link pb-3 active keep-param" data-i18n="ELSA for Schools" href="/en/schools" id="footer-nav-teams">ELSA for Schools</a>
                            <a class="nav-link active keep-param" href="#goi-san-pham" data-i18n="Plans" id="footer-nav-plans">Plans</a>
                        </div>
                        <div class="col-4 text-left font-weight-600">
                            <a class="nav-link pb-3 active keep-param" href="#" data-i18n="ELSA for Enterprises" id="footer-nav-enterprise">ELSA for Enterprises</a>
                            <a class="nav-link active keep-param" data-toggle="modal" data-target="#exampleModal" data-i18n="Register Now" id="footer-nav-booking">Register Now</a>
                        </div>
                        <div class="col-4 text-left font-weight-600">
                    ...
                    <div class="row d-lg-none d-xs-inline-flex">
                        <div class="col-6 text-left font-weight-600">
                            <a class="nav-link pb-3 active keep-param" href="/en/schools" data-i18n="ELSA for Schools" id="footer-nav-m-teams">ELSA for Schools</a>
                        ...
                        <div class="col-6 text-left font-weight-600">
                            <a class="nav-link pb-3 active keep-param" href="/b2b/booking-demo" data-i18n="ELSA for Enterprises" id="footer-nav-m-enterprise">ELSA for Enterprises</a>
                            <a class="nav-link pb-3 keep-param" data-toggle="modal" data-target="#exampleModal" data-i18n="Register Now" id="footer-nav-m-booking">Register Now</a>
                ...
                <div class="col-lg-6 col-md-12 pb-4 text-white align-right">
                    ...
                    <ul class="list-group list-group-horizontal">
                        <li class="list-group-item pr-2 pl-0">
                            <a href="https://apps.apple.com/vn/app/elsa-learn-and-speak-english/id1083804886" id="download-ios">
                                <img src="https://elsaspeak.com/wp-content/uploads/2020/12/Appstore.svg" class="appstore" />
                            </a>
                        </li>
                        <li class="list-group-item pl-2 pr-0">
                            <a href="https://play.google.com/store/apps/details?id=us.nobarriers.elsa" id="download-android">
    ...
    <script src="https://ajax.cloudflare.com/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="b2c9fa69bf21bf5a311ec2b5-|49" defer=""></script>
    <script>
